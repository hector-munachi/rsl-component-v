...
export default {
  ...
  setup() {
    ...
    const region = computed(() => {
      return regionsByState.value[selectedState.value] || '';
    });
    const lgas = computed(() => {
      return selectedState.value ? lgaList[selectedState.value] || [] : [];
    });
